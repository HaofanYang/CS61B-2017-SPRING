...
public class IntListTest {
    ...
    public void testReverse(){
        IntList L = IntList.list(1,4,5,6);
        IntList reverse = L.reverse();
        assertEquals( IntList.list(6,5,4,1),reverse);
        assertNotEquals(IntList.list(1,4,5,6),L);
        assertEquals( new IntList(), new IntList().reverse());
    }
